...
echo"<html>";
echo"<head>";
echo'<link href="'.base_url().'application/css/default.css" rel="stylesheet" type="text/css" media="all">
<link href="'.base_url().'application/css/stylesheet.css" rel="stylesheet" type="text/css" media="all">
<!--<link href="/'.base_url().'application/css/small-resolution.css" rel="stylesheet" type="text/css" media="all">
<link href="'.base_url().'application/css/medium-resolution.css" rel="stylesheet" type="text/css" media="all">
<link href="'.base_url().'application/css/high-resolution.css" rel="stylesheet" type="text/css" media="all">';
echo'<script src="'.base_url().'application/js/jquery.bxslider.min.js"></script>
<script src="'.base_url().'application/js/script.js" type="text/javascript"></script>
<link href="'.base_url().'application/css/jquery.bxslider.css" rel="stylesheet" />
<link href="'.base_url().'application/css/responsive.css" rel="stylesheet" />';
echo'</head><body>';
?>
...
<link href="'.base_url().'application/css/default.css" rel="stylesheet" type="text/css" media="all">
<link href="'.base_url().'application/css/stylesheet.css" rel="stylesheet" type="text/css" media="all">
<!--<link href="/var/www/html/Assignment_3/css/small-resolution.css" rel="stylesheet" type="text/css" media="all">
<link href="/var/www/html/Assignment_3/css/medium-resolution.css" rel="stylesheet" type="text/css" media="all">
<link href="/var/www/html/Assignment_3/css/high-resolution.css" rel="stylesheet" type="text/css" media="all">-->

<!-- jQuery library (served from Google) -->
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
<!-- bxSlider Javascript file -->
<script src="'.base_url().'application/js/jquery.bxslider.min.js"></script>
<script src="'.base_url().'application/js/script.js" type="text/javascript"></script>
