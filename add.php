...
<style>
    #vfn,#vln,#vphn,#vofc,#vemail,#vpin,#vpwd,#vcpwd,#vmon,#vday,#vyear,#vage,#vradio,#vabt{color: #F32323}
    </style>
 ...
 <!--header-starts-->
  ...
  <div class="section content_section">
	<div class="container">
            ...
            <form id="frm1" method="POST" action="add_emp.php">
			...
			<div class="form_container_block">
                ...
                <div class="next_btn_block">
					<div class="next_btn">
                                            ...
                                            <input type="submit" value="Next"><span><img src="images/small_triangle.png" alt="small_triangle"> </span></a>
